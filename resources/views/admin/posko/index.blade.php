        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Data Posko</h4>
                    </div>
                    <div class="col-sm-4">
                    </div>
                    @can('can_admin')
                                            ...
                                            <tbody id="organisasi_body">
                                                ...
                                                <tr id="item{{$pk->id}}">
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('can_admin')
                                                        @if(\DB::table('posko_user')->where('posko_id', $pk->id)->exists())
                                                            <a href="#user-posko" data-target="#user-posko" class="btn btn-outline-info" data-toggle="modal" ><i class="fas fa-user" style="color: white;"></i></a>
                                                        @else
                                                            <a onclick="event.preventDefault(); document.getElementById('user-posko-form').submit();" class="btn btn-outline-success" data-toggle="modal" ><i class="fas fa-user-plus" style="color: white;"></i></a>

                                                            <form id="user-posko-form" action="{{route('admin.user.posko', $pk->id)}}" method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        @endif
            ...
            <div class="modal-body">
                ...
                <form class="" action="{{route('admin.posko.update', $pk->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="wa" type="text" name="wa" class="form-control border border-light" placeholder=" . . . . . . . . . . . " />
                    </div>
                    <div class="form-group">
...
<div class="modal fade bs-example-modal-center" id="user-posko" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <span id="user-posko"></span>
                    <div class="form-group">
                        ...
                        <input placeholder="{{$user->nrp}}" id="nrp" readonly type="text" name="nrp" class="form-control border border-light"/>
                    </div>    
                    <div class="form-group">
                        <label>Dibuat Pada</label>
                        <input placeholder="{{$user->created_at}}" id="alamat_ktp" readonly type="text" name="alamat_ktp" class="form-control border border-light"/>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->

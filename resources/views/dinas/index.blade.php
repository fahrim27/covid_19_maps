                                        ...
                                        <table id="tech-companies-1" class="table table-striped table-bordered" >
                                            <thead>
                                                <tr>
                                                    <th>No Telp</th>
                                                    <th>Nama</th>
                                                    <th data-priority="2">Usia</th>
                                                    <th data-priority="3">Jenis Kelamin</th>
                                                    <th>Kasus</th>
                                                    <th data-priority="5">Isolasi</th>
                                            ...
                                            <tbody id="organisasi_body">
                                                ...
                                                <tr id="item{{$ps->id}}">
                                                    ...
                                                    <td>
                                                        <a title="lihat detail pasien {{$ps->nama}}" data-id="{{$ps->id}}" class="btn btn-outline-info detail" data-toggle="modal"><i class="fas fa-fas fa-map-marked-alt" style="color: white;"></i></a>
                                                      </td>
                                                </tr>
